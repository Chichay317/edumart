        ...
        <>
          <div className="bg-white">
            <div className="flex items-center justify-between">
              <p className="text-[#0C2953] text-xl font-medium">Edit Image</p>
              <AiOutlineClose
                className="text-[#0C2953] text-xl font-medium"
          ...
          <div className="bg-white p-4 mt-5">
            <ul className="list-disc">
              <li className="text-[#0C2953] text-lg font-medium mb-3">
              ...
              <li className="text-[#0C2953] text-lg font-medium">
          ...
          <div className="flex items-center justify-end mt-5">
            <button
              onClick={onSave}
              className="bg-[#0C2953] px-8 py-2 text-white font-medium text-lg rounded-lg"
            >
              Save
            </button>
          </div>
